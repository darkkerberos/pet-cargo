...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-header text-muted-foreground py-12">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-muted-foreground/80 text-sm text-center md:text-left">
              © {currentYear} DARIN PET'S TRANSPORT. All rights reserved.
            </p>
            {/* <div className="flex items-center gap-2 text-sm text-white/80">
              <span>Authorize by</span>
              <span>@dark.kerberos05</span>
