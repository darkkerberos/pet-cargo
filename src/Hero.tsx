        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-white space-y-6 animate-in fade-in slide-in-from-left duration-700">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              Perjalanan Aman untuk Hewan Kesayangan Anda
            </h2>
            <p className="text-xl md:text-2xl text-white/90">
              Layanan transportasi hewan peliharaan terpercaya sejak 2016
            </p>
            <p className="text-lg text-white/80">
              Kami mengantarkan hewan kesayangan Anda dengan aman, cepat, dan penuh perhatian ke seluruh Indonesia dan mancanegara.
            </p>
